...
const WindowsDownloadPanel = document.getElementById('downwindows')
const AndroidDownloadPanel = document.getElementById('downandroid')
let haserror = false
...
document.getElementById('downwin').addEventListener("click", OpenDownloadWin)
document.getElementById('downand').addEventListener("click", OpenDownloadAndroid)
...
function OpenDownloadWin() {
    AndroidDownloadPanel.style.display = 'none'
    WindowsDownloadPanel.style.display = 'block'
    document.addEventListener("keydown", (event) => { 
        setTimeout(CloseAll, 100);
    });
    WindowsDownloadPanel.addEventListener("click", function() {
        setTimeout(CloseAll, 100);
    });
}

function OpenDownloadAndroid() {
    AndroidDownloadPanel.style.display = 'block'
    WindowsDownloadPanel.style.display = 'none'
    document.addEventListener("keydown", (event) => { 
        setTimeout(CloseAll, 100);
    });
    AndroidDownloadPanel.addEventListener("click", function() {
        setTimeout(CloseAll, 100);
    });
}
